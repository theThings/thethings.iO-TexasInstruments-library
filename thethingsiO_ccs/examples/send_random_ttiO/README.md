  <div id="readme" class="readme blob instapaper_body">
    <article class="markdown-body entry-content" itemprop="text"><h1><a id="user-content-arduino" class="anchor" href="#energia" aria-hidden="true"><svg aria-hidden="true" class="octicon octicon-link" height="16" role="img" version="1.1" viewBox="0 0 16 16" width="16"><path d="M4 9h1v1h-1c-1.5 0-3-1.69-3-3.5s1.55-3.5 3-3.5h4c1.45 0 3 1.69 3 3.5 0 1.41-0.91 2.72-2 3.25v-1.16c0.58-0.45 1-1.27 1-2.09 0-1.28-1.02-2.5-2-2.5H4c-0.98 0-2 1.22-2 2.5s1 2.5 2 2.5z m9-3h-1v1h1c1 0 2 1.22 2 2.5s-1.02 2.5-2 2.5H9c-0.98 0-2-1.22-2-2.5 0-0.83 0.42-1.64 1-2.09v-1.16c-1.09 0.53-2 1.84-2 3.25 0 1.81 1.55 3.5 3 3.5h4c1.45 0 3-1.69 3-3.5s-1.5-3.5-3-3.5z"></path></svg></a>Texas Instruments CSS example: Send random numbers</h1>

<p>Texas Instruments example for Code Composer Studio to connect to <a href="http://thethings.iO">http://thethings.iO</a></p>

<h2>Instructions</h2>

In the example folder you can find the source code for this example. To try this example, the easiest method is to download the send_random_ti_css.zip. Then, in Code Composer Studio go to 'Project' -> 'Import CSS Project...'. In the window that will open choose 'Select Archive File', then 'Browse' and navigate to the .zip file you just downloaded, select it and click on 'Open'. After that, 'send_random_ttiO' should appear as a discovered project. Mark it and click 'Finish' to import.
...
In this example, we generate random  numbers and send them to thethings.iO. The only line you have to change is the line where the token is declared, to one of your tokens. Then upload the project to your launchpad, execute it and you can see in the terminal how the random numbers are generated. Now you are ready to  access your account at thethings.iO and go to the details of the thing and token you are sending the data to. Click on 'Real-time' and voilà! You can see the numbers arriving!
