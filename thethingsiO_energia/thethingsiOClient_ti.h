...
#ifndef THETHINGSCLIENT_TI_H
#define THETHINGSCLIENT_TI_H

#include <Arduino.h>
#include <Client.h>

class thethingsiOClient_ti {
public:
    thethingsiOClient_ti(Client *, Client *);
    thethingsiOClient_ti(Client *, Client *, String &);
    ...
    // key: string
    // value: numb
     void addValue(String, int, double lon = 999, double lat = 999);
